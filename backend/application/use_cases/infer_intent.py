...
# Caso de uso para inferir la intención de una sesión cerrada (Clean Architecture)
class InferIntentUseCase:
    ...
    def execute_for_session(self, session_id: str) -> Any | None:
        ...
        # Convierte y valida la respuesta del LLM a un IntentRecord
        try:
        ...
        # Persiste el registro de intención e introduce los datos clave en la sesión
    ...
    def execute_for_all_closed(self) -> int:
        # Ejecuta la inferencia sobre todas las sesiones que estén cerradas
